      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 w-[1238px] max-w-full h-[452px] max-md:h-auto mx-auto">
        ...
        <div className="-ml-2 max-md:ml-0 max-md:mt-0 max-sm:px-4">
          ...
          <p
            data-aos="fade-up"
            data-aos-duration="2000"
            className="text-[16px] mb-5.5 leading-[1.4] text-black max-md:text-[15px] max-sm:text-[14px]"
          >
            {content.description}
          </p>
          ...
          <p
            data-aos="fade-up"
            data-aos-duration="2000"
            className="text-black font-bold text-[16.5px] max-md:text-[15px] max-sm:text-[14px]"
          >
          ...
          <ul
            data-aos="fade-up"
            data-aos-duration="2000"
            className="list-disc ml-6 text-[16px] text-black leading-[1.4] max-md:text-[15px] max-sm:text-[14px]"
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-duration="2000"
            className="text-[16px] mt-6 text-black leading-[1.4] max-md:text-[15px] max-sm:text-[14px]"
          >
            {content.closing}
          </p>
        </div>
          ...
          <div className="rounded-l-[3rem] overflow-hidden h-full flex items-center w-[120%] max-md:w-full max-sm:rounded-xl">
            ...
            >
              <h3
                data-aos="fade-up"
                data-aos-duration="2000"
                className="text-[42px] font-bold md:text-[45px] mb-2 text-white leading-[1.1] ml-20 max-md:ml-0 max-sm:text-[28px]"
              >
                {content.ctaHeading}
              </h3>
