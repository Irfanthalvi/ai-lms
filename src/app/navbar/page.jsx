...
const Navbar = () => {
  return (
    <header
      className="fixed top-0 left-0 z-50 w-full h-[65px] bg-background backdrop-blur-xl border-b 
      border-border/5 flex items-center justify-center"
    >
      <div className="w-full flex items-center justify-between gap-[60px] px-[225px] relative
      max-xl:px-[100px] max-lg:px-[60px] max-md:px-[30px] max-sm:px-4">
